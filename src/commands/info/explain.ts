...
const explainDope = async (interaction: ChatInputCommandInteraction): Promise<void> => {
    const dopeImage = Sharp('./images/dope.svg').png();
    const imageFile = new AttachmentBuilder(dopeImage)
        .setName("dope.png");
...
const explainHustler = async (interaction: ChatInputCommandInteraction): Promise<void> => {
...
const explaingOgs = async (interaction: ChatInputCommandInteraction): Promise<void> => {
    const ogImage = Sharp("./images/og.svg").png();
    const imageFile = new AttachmentBuilder(ogImage)
        .setName("og.png");
...
const explainGear = async (interaction: ChatInputCommandInteraction): Promise<void> => {
    const gearImage = Sharp('./images/tricycle.svg').png();
    const imageFile = new AttachmentBuilder(gearImage)
        .setName("gear.png");
...
const explainTurf = async (interaction: ChatInputCommandInteraction): Promise<void> => {
...
const explainPaper = async (interaction: ChatInputCommandInteraction): Promise<void> => {
